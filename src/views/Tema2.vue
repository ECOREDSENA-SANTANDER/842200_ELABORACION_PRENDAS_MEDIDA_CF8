          ...
          .row.justify-content-center.mb-4
            .col-lg-5.col-md-12.col-12.mb-4
              .titulo-sexto.color-acento-contenido
                ...
                | Aumento (opción 1)
              .shadow
                img(data-aos="zoom-in")(src='@/assets/curso/tema2/img02.png', alt='Fotografía de unas manos cortando con unas tijeras por la  línea de modificación.')
        ...
        .cajaverdec.p-4
          ...
          .row.justify-content-center.mb-4
            .col-lg-5.col-md-12.col-12.mb-4
              .titulo-sexto.color-acento-contenido.mb-2
                h5 Figura 13.
                | Varillas en guateado
              .shadow
                img(data-aos="zoom-in")(src='@/assets/curso/tema2/img09.png', alt='En la fotografía se presenta la guata sostenida por unas manos que ingresa la varilla.')
                .texto-imagenes.py-2.px-1
                  p.mb-0.px-2.py-2
