    ...
    .row.justify-content-center.mb-5(data-aos="fade-right")
      .col-lg-6.col-md-10.col-10
        .titulo-sexto.color-acento-contenido.mb-5
          h5 Figura 21.
          | Supraciclaje
        img.mb-3(data-aos="zoom-in")(src='@/assets/curso/tema4/img01.jpg', alt='La imagen contiene diagrama en el que se indica que desde productos desfasados y desechos se pueden obtener productos con valor añadido.')  
