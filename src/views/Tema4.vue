...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.mb-5
      .col-lg-6.col-md-10.col-10
        .titulo-sexto.color-acento-contenido.mb-5
          h5 Figura 6
          | Supraciclaje
        img.mb-3(src='@/assets/curso/tema4/img01.jpg', alt='La imagen contiene diagrama en el que se indica que desde productos desfasados y desechos se pueden obtener productos con valor añadido.')  
        img.mb-3.imagen-mobile(src='@/assets/curso/tema4/img01.1.svg', alt='La imagen contiene diagrama en el que se indica que desde productos desfasados y desechos se pueden obtener productos con valor añadido.')  
    ...
    .row.justify-content-center.mb-5 
      .col-lg-4.col-md-10.col-10
        .titulo-sexto.color-acento-contenido.mb-2
          h5 Figura 8
          | Residuos textiles
        img.mb-2(src='@/assets/curso/tema4/img03.png', alt='La imagen contine fotografía de mucha cantidad de residuos textiles, debidamente almacenados') 
        figcaption Nota. Tomada de Sea (2021)
      .col-lg-8.col-md-12.col-12
        .caja4.p-4
          ...
          ul.lista-ul--color
            li.d-flex.mb-4
              i.fas.fa-circle
              | El poliéster es una base para construir textiles cuya composición no permite la transpiración fácilmente, dependiendo si es de chaquetas, polos o prendas más pesadas, también se encuentran ligeras que tienen efecto impermeable.
            li.d-flex.mb-4
              i.fas.fa-car-side
              | El algodón, al ser una fibra natural, permite la transpiración, pero el ciclo de vida del producto es inferior al del poliéster u otra fibra sintética o artificial.
            li.d-flex.mb-4
              i.fas.fa-car-side
              | No conocer la composición puede llegar a crear combinaciones inadecuadas para el bienestar de las personas y, al final, el producto no cumpliría su objetivo principal que es el de ser usado nuevamente.
    
    p.mb-5 Para muchos es sencillo expresar que es mejor la eliminación de productos, pero estos emiten gases y elementos que son perjudiciales para el planeta, pues debilitan la capa de ozono afectando el mundo entero, es por esto que se debe ser más consciente a la hora de seleccionar los productos y velar porque la composición y combinación sean las adecuadas. Las fibras, como bien se ha mencionado, pueden ser de origen natural o sintético (artificial), por lo que se encuentran un sinnúmero de resultados en cuanto a fibras textiles, como se indica en la siguiente tabla. 
    ...
    .tabla-b.color-acento-contenido
      ...
      table               
        tr
          th.th(rowspan=3) De origen Animal
          td Ovinos            
          td Lana
        tr         
        ...
        tr
          th.tt(rowspan=3) De origen vegetal
          td Fruto           
    ...
    p.mb-4 A continuación, se presenta un esquema que resume gran parte del proceso en cuanto a manejo de los residuos textiles y su transformación.
    ...
    .row.justify-content-center.mb-5 
      .col-lg-8.col-md-12.col-12
        ...
        img.mb-4.d-none.d-lg-block(src='@/assets/curso/tema4/img07.jpg', alt=' El diagrama ilustra el ciclo del reciclaje en la industria textil. En el medio una persona que reúsa las prendas, relacionándose con el punto de venta y la clasificación que hacen parte del ciclo, adicional a esto se presentan la preparación para el reciclaje, el reciclaje de bucle cerrado y la  industria textil. También se menciona el reciclaje de bucle abierto, que es el que termina en el aprovechamiento de las prendas recicladas en otra industrias.')
        img.mb-4.imagen-mobile(src='@/assets/curso/tema4/img07.1.jpg', alt=' El diagrama ilustra el ciclo del reciclaje en la industria textil. En el medio una persona que reúsa las prendas, relacionándose con el punto de venta y la clasificación que hacen parte del ciclo, adicional a esto se presentan la preparación para el reciclaje, el reciclaje de bucle cerrado y la  industria textil. También se menciona el reciclaje de bucle abierto, que es el que termina en el aprovechamiento de las prendas recicladas en otra industrias.')
        figcaption Nota. Tomada de García (2018)

    p.mb-4 Lo anterior es cuando se logra la transformación de la prenda, cuando esto no sucede se pueden aplicar estrategias solo de reciclaje en las que la fibra no será transformada pero sí reutilizada.
